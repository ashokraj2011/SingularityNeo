        ...
        {workItem ? (
          <>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2">
              {gitWorkspace && (
                <span className="flex items-center gap-1 rounded bg-surface-container px-1.5 py-0.5 font-mono text-[0.62rem] text-secondary">
                  <GitBranch size={9} />
                  {gitWorkspace.branchName || gitWorkspace.workspacePath.split("/").slice(-2).join("/")}
                </span>
              )}
